...
public interface pb {
	...
	public abstract int deldteByUid(int uid); /* 5 */
...
//	public static final int QUERY_FAIL = 0;
	...
	public static final String SQL_UPDATE_BY_UID = "UPDATE " + TBL_NAME + " SET " 
							+  COL_LABEL_NAME +" = ? ," + COL_LABEL_PHONENUM +" = ? ,"+ COL_LABEL_MEMO +" = ? WHERE " + COL_LABEL_UID +" = ?";
	public static final String SQL_DELETE_BY_UID = "DELETE FROM " + TBL_NAME + " WHERE " +  COL_LABEL_UID +" = ?";
	
	public static final String SQL_SELECT_BY_UID = "SELECT * FROM " + TBL_NAME + " WHERE " +  COL_LABEL_UID +" = ?";
	//TODO :  추가로 필요한 쿼리문 
}
