...
public class DateTime03Main {
	...
	public static void main(String[] args) {
		...
		DateFormat df = null; // simple DateFormat 부모
		Date date = null;
		...
		// 양수넣으면 +, 음수 넣으면 -
//     cal.add(Calendar.MONTH, 2); // 달 
		cal.add(Calendar.DATE, 30); // 날짜
		...
		System.out.println("변경후 시간 : " + df.format(cal.getTime()));
...
//		cal.add(Calendar.DATE, -cal2.get(Calendar.DATE)); // 음수
