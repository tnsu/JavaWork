...
public class Wrapper02Main {
	...
	public static void main(String[] args) {
		...
		Integer num1 = 10; // Integer.valueOf(10); <- auto-boxing  내부적으로 자동적으로 실행됨
		Integer num2 = 20; 
		System.out.println(num1+num2);  // auto-unboxing 
		System.out.println(num1.intValue() + num2.intValue()); // <-- 이와 같이 동작함
		
		Integer num3 = num1 + num2; // 내부적으로 아래와 같이 동작함 , 자동으로 박싱과 언박싱을 하기 때문에 밑처럼 안써도됨
		...
		Long num101 = 100000000000L;
		
		Double num200 = 3.14; // Double.valueOf(3.14)
		
		
		// unboxing은  원하는 타입로 꺼낼수 있다.
