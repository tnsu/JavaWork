...
//  웹이나 앱개발시에는 문자열로 입력받고 ,나중에 변환해준다.
...
public class Input04Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("숫자 3개(int, int, int)를 입력하세요 > "); 
		String in1 = sc.next(); 
		int i1 = Integer.parseInt(in1); // NumberFormatException 숫자를 입력하지 않고 문자를 입력했을시 발생함
		...
		// 실수 3개를 문자열로 입력받아서 (next()) 3 실수의 곱을 계산하여 출력하기
		...
		System.out.println("3개의 곱 : " +( n1 * n2 * n3)) ;
