...
console.log('fruits =', fruits.toString()); // 문자열로 만듬. json 변환할 때  ?
...
console.log(fruits.toString());
console.log(fruits.unshift('Grape')); // 배열앞추가 새 length 리턴
console.log(fruits.toString());
