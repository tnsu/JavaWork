...
public class Crawl05Main {
	...
	private ArrayList<InfoBook> crawlYes24(String search) throws IOException{ // main 에서 다이렉트로 선언이안되서 app 인스턴스 생성
		...
		rowElements = doc.select("#schMid_wrap > div.goods_list_wrap.mgt30").get(0).select("tr:nth-child(odd)"); //get(0) 첫번쨰꺼골라내기
