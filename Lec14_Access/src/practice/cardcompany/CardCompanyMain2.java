...
public class CardCompanyMain2 {

	// ★ 아래 main() 코드는 손대지 마세요 ★
	public static void main(String[] args) {

		Company2 com = Company2.getInstance();  // 싱글톤 패턴
		Company2 company = Company2.getInstance();  // 여러번 호출해도 동일 객체
				
		// ↓ '동일객체' 라고 결과가 나와야 한다.
		System.out.println((com == company) ? "동일객체" : "다른객체");
		
		Card2 myCard = company.createCard();  // 첫번째 카드생성 고유번호 10001 부여 
		Card2 yourCard = company.createCard();
