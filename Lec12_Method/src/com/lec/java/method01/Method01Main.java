...
public class Method01Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("제 이름은 한수빈 입니다.");
		...
		sayAge(16);
		sayAge(20);
		com.lec.java.method01.Method01Main.sayAge(1); // 이렇게 써도 동작함
		
		System.out.println();
		
		sayHello2("김우경", 25);
//		sayHello2(100, 25); // not applicable for the arguments 에러	
//  	정의되어 있는 매개변수 리스트와 다르게 호출될시 발생
	...
	// 메소드 위에 아래와 같이 javadoc 타임 주석 달수 있다.
	/**
	 * 메소드 이름 :sayHello 
	 * 주어진 이름을 출력합니다.
	 * @param name 이름
	...
	public static void sayAge(int age) {
		...
		System.out.println("제 나이은 " + age + "살 입니다.");
	}// end sayAge
	...
	public static void sayHello3(String name, int age) {
		sayHello(name);
		sayAge(age);
	} // end sayHello3() //메서드가 메서드를 호출할수있음
